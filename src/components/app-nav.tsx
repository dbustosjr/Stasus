...
export function AppNav({ active }: AppNavProps) {
  ...
  const linkClass = (key: AppTabKey) =>
    `inline-flex min-h-11 shrink-0 items-center rounded-full px-3 py-2 text-sm font-medium transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--stasus-aqua)] active:scale-[0.98] sm:px-4 ${
      optimistic === key
